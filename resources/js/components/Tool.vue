<template>
  <div>
    ...
    <div class="grid gap-4 grid-cols-3 md:grid-cols-2 lg:grid-cols-3">
      <div class="bg-white px-4 py-5 border-b border-gray-200 sm:px-6 mb-4" v-for="group in groups">
        <div class="flex items-center justify-between flex-wrap sm:flex-nowrap mb-3 text-center">
          <hr class="border-0 border-gray-200 border-b-2 text-center text-2xl w-full block flex-auto">
          <h3 class="text-lg leading-6 font-medium text-gray-900 flex-auto whitespace-nowrap px-3">
